...
function DetalhesPacientePage() {
  ...
  async function handleDeletar() {
    ...
    try {
      ...
      setLesoesPrecisaAprovacao((lesoesAtuais) =>
        lesoesAtuais.filter((lesao) => lesao.id !== lesaoIdParaDeletar)
      );
    } catch (error) {
          ...
          <Card className="mt-6 shadow-sm border rounded-xl">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                ...
                />
                <Info label="Medicamento" value={paciente.medicamento || "-"} />
                <Info
            ...
            {lesoesPrecisaAprovacao.length > 0 ? (
              lesoesPrecisaAprovacao.map((lesao) => (
                <LesaoCard
                  ...
                  tipo="pendente"
                  onExcluir={() => {
                    setLesaoIdParaDeletar(lesao.id);
                    setOpenDialog(true);
                  }}
                />
              ))
